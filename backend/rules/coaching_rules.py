...
def generate_suggestions(metrics: Dict[str, Any], stroke: str) -> Dict[str, list]:
    ...
    if shoulder_turn is not None:
        if shoulder_turn < 20:
            ...
            _add(doing_well, "Great upper body coil on the forehand—lots of stored power as long as you stay balanced.")
    ...
    if height is not None:
        if height < 0.3:
            ...
            _add(work_on, "You're contacting the ball quite high; make sure you can still swing up and through comfortably.")
    ...
    if follow_turn is not None:
        if follow_turn < 20:
            ...
            _add(doing_well, "Big rotation through the shot—great for power, as long as you stay balanced over your base.")
